...
class GitCLIService {
    ...
    async clone(from, to, branch) {
        ...
        if (!fs_1.default.existsSync(to)) {
            await (0, simple_git_1.default)().clone(this.remoteWithAuth(from), to, ["--quiet", "--filter=blob:none", "--shallow-submodules", "--no-tags", "--branch", branch]);
            return;
        }
...
class GitHubClient {
     ...
     */
    extractCommitMessage(commitData) {
     ...
     */
    async getCommits(owner, repo, prNumber) {
        try {
...
const debug_1 = __importDefault(__nccwpck_require__(8237));
const promisify_1 = __importDefault(__nccwpck_require__(6948));
...
const debug_1 = __importDefault(__nccwpck_require__(8237));
const agent_base_1 = __nccwpck_require__(7401);
const parse_proxy_response_1 = __importDefault(__nccwpck_require__(8494));
...
const agent_1 = __importDefault(__nccwpck_require__(9808));
...
var init_CheckIgnore = __esm({
  "src/lib/responses/CheckIgnore.ts"() {
    "use strict";
    import_node_path = __nccwpck_require__(9411);
...
var crypto = __nccwpck_require__(6113);
var url = __nccwpck_require__(7310);
var HttpsProxyAgent = __nccwpck_require__(8414);
var http = __nccwpck_require__(3685);
var https = __nccwpck_require__(5687);
